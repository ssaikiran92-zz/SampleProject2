...
public class PortInformation {
	...
	public String serviceAreaValue;
	public boolean serviceAreaIsUpdatable;
	...
	public boolean ethernetIsDisplayed;
	public ArrayList<String> serviceActivityDropdownList = new ArrayList<String>(20);
	public boolean serviceActivityIsUpdatable;
	public boolean serviceActivityIsRequired;
	public boolean serviceActivityIsSelected;
	public boolean serviceActivityIsDisplayed;
	public String serviceActivitySelectedValue;
	public ArrayList<String> avpnManagementDropdownList = new ArrayList<String>(20);
	public boolean avpnManagementIsUpdatable;
	public boolean avpnManagementIsRequired;
	public boolean avpnManagementIsSelected;
	public boolean avpnManagementIsDisplayed;
	public String avpnManagementSelectedValue;
	...
	public boolean isServiceIsUpdatable() {
		return serviceIsUpdatable;
	}
	public boolean isServiceIsRequired() {
		return serviceIsRequired;
	}
	public boolean isServiceIsSelected() {
		return serviceIsSelected;
	}
	public boolean isServiceIsDisplayed() {
		return serviceIsDisplayed;
	}
	public String getServiceAreaValue() {
		return serviceAreaValue;
	}
	public boolean isServiceAreaIsUpdatable() {
		return serviceAreaIsUpdatable;
	}
	public boolean isServiceAreaIsRequired() {
		return serviceAreaIsRequired;
	}
	public boolean isServiceAreaIsSelected() {
		return serviceAreaIsSelected;
	}
	...
	public boolean isEthernetIsRequired() {
		return ethernetIsRequired;
	}
	public boolean isEthernetIsSelected() {
		return ethernetIsSelected;
	}
	public boolean isEthernetIsDisplayed() {
		return ethernetIsDisplayed;
	}
	public ArrayList<String> getServiceActivityDropdownList() {
		return serviceActivityDropdownList;
	}
	public boolean isServiceActivityIsUpdatable() {
		return serviceActivityIsUpdatable;
	}
	public boolean isServiceActivityIsRequired() {
		return serviceActivityIsRequired;
	}
	public boolean isServiceActivityIsSelected() {
		return serviceActivityIsSelected;
	}
	public boolean isServiceActivityIsDisplayed() {
		return serviceActivityIsDisplayed;
	}
	public String getServiceActivitySelectedValue() {
		return serviceActivitySelectedValue;
	}
	public ArrayList<String> getAvpnManagementDropdownList() {
		return avpnManagementDropdownList;
	}
	public boolean isAvpnManagementIsUpdatable() {
		return avpnManagementIsUpdatable;
	}
	public boolean isAvpnManagementIsRequired() {
		return avpnManagementIsRequired;
	}
	public boolean isAvpnManagementIsSelected() {
		return avpnManagementIsSelected;
	}
	public boolean isAvpnManagementIsDisplayed() {
		return avpnManagementIsDisplayed;
	}
	public String getAvpnManagementSelectedValue() {
		return avpnManagementSelectedValue;
	}
	public void setServiceValue(String serviceValue) {
		this.serviceValue = serviceValue;
	}
	public void setServiceIsUpdatable(boolean serviceIsUpdatable) {
		this.serviceIsUpdatable = serviceIsUpdatable;
	}
	public void setServiceIsRequired(boolean serviceIsRequired) {
		this.serviceIsRequired = serviceIsRequired;
	}
	public void setServiceIsSelected(boolean serviceIsSelected) {
		this.serviceIsSelected = serviceIsSelected;
	}
	public void setServiceIsDisplayed(boolean serviceIsDisplayed) {
		this.serviceIsDisplayed = serviceIsDisplayed;
	}
	public void setServiceAreaValue(String serviceAreaValue) {
		this.serviceAreaValue = serviceAreaValue;
	}
	public void setServiceAreaIsUpdatable(boolean serviceAreaIsUpdatable) {
		this.serviceAreaIsUpdatable = serviceAreaIsUpdatable;
	}
	public void setServiceAreaIsRequired(boolean serviceAreaIsRequired) {
		this.serviceAreaIsRequired = serviceAreaIsRequired;
	}
	public void setServiceAreaIsSelected(boolean serviceAreaIsSelected) {
		this.serviceAreaIsSelected = serviceAreaIsSelected;
	}
	public void setServiceAreaIsDisplayed(boolean serviceAreaIsDisplayed) {
	...
	public void setEthernetIsRequired(boolean ethernetIsRequired) {
		this.ethernetIsRequired = ethernetIsRequired;
	}
	public void setEthernetIsSelected(boolean ethernetIsSelected) {
		this.ethernetIsSelected = ethernetIsSelected;
	}
	public void setEthernetIsDisplayed(boolean ethernetIsDisplayed) {
		this.ethernetIsDisplayed = ethernetIsDisplayed;
	}
	public void setServiceActivityDropdownList(ArrayList<String> serviceActivityDropdownList) {
		this.serviceActivityDropdownList = serviceActivityDropdownList;
	}
	public void setServiceActivityIsUpdatable(boolean serviceActivityIsUpdatable) {
		this.serviceActivityIsUpdatable = serviceActivityIsUpdatable;
	}
	public void setServiceActivityIsRequired(boolean serviceActivityIsRequired) {
		this.serviceActivityIsRequired = serviceActivityIsRequired;
	}
	public void setServiceActivityIsSelected(boolean serviceActivityIsSelected) {
		this.serviceActivityIsSelected = serviceActivityIsSelected;
	}
	public void setServiceActivityIsDisplayed(boolean serviceActivityIsDisplayed) {
		this.serviceActivityIsDisplayed = serviceActivityIsDisplayed;
	}
	public void setServiceActivitySelectedValue(String serviceActivitySelectedValue) {
		this.serviceActivitySelectedValue = serviceActivitySelectedValue;
	}
	public void setAvpnManagementDropdownList(ArrayList<String> avpnManagementDropdownList) {
		this.avpnManagementDropdownList = avpnManagementDropdownList;
	}
	public void setAvpnManagementIsUpdatable(boolean avpnManagementIsUpdatable) {
		this.avpnManagementIsUpdatable = avpnManagementIsUpdatable;
	}
	public void setAvpnManagementIsRequired(boolean avpnManagementIsRequired) {
		this.avpnManagementIsRequired = avpnManagementIsRequired;
	}
	public void setAvpnManagementIsSelected(boolean avpnManagementIsSelected) {
		this.avpnManagementIsSelected = avpnManagementIsSelected;
	}
	public void setAvpnManagementIsDisplayed(boolean avpnManagementIsDisplayed) {
		this.avpnManagementIsDisplayed = avpnManagementIsDisplayed;
	}
	public void setAvpnManagementSelectedValue(String avpnManagementSelectedValue) {
		this.avpnManagementSelectedValue = avpnManagementSelectedValue;
	}
